...
public class HashApp {
	...
	// RBTreeMap
	System.out.println( "RBTreeMap" );
	RBTreeMap<Integer,Integer> RBTM = new RBTreeMap<>();
	// measure insertion time
	startTime = System.nanoTime();
	for( int i = 0; i < numberIn; i++ ) {
	    int r = (int)(Math.random() * numberIn );
	...
	System.out.println( ( System.nanoTime() - startTime ) / 1000000 + " milliseconds for insertions" );
	//System.out.println( "avg resctucture: " + ( (double)AVL.getNumberOfRestructure() / (double)numberIn ) );
	...
	System.out.println( ( System.nanoTime() - startTime ) / 1000000 + " milliseconds for searches" );
    	...
    	// measure remove time
	//AVL.resetNumberOfRestructure();
	int numberOut = 0;
	startTime = System.nanoTime();
	// make a number of removes
	for( int i = 0; i < numberIn; i++ ) {
	    int r = (int)(Math.random() * numberIn );
	    if( AVL.remove( r ) != null ) numberOut++;
	}
	System.out.println( ( System.nanoTime() - startTime ) / 1000000 + " milliseconds for removes" );
	//System.out.println( "avg resctucture: " + ( (double)AVL.getNumberOfRestructure() / (double)numberOut ) );
